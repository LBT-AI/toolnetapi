...
Integrate ToolNet API with Continue extension to bring AI assistance directly into Visual Studio Code.
...
### 2. Add ToolNet API Model Configuration
...
3. Choose your preferred ToolNet API model
...
- Check network latency to ToolNet API
