...
const hasToolNetAPIConfig = (globalState) => {
  ...
  return isOpenAi && (baseUrl.includes("localhost") || baseUrl.includes("127.0.0.1") || baseUrl.includes("toolnetapi"));
};
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ success: true, message: "ToolNet API settings removed from Cline" });
  } catch (error) {
