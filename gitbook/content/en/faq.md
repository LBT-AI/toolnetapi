...
Common questions about ToolNet API.

---

## What is ToolNet API?

**ToolNet API is an AI model router that maximizes your subscription value and minimizes costs.**
...
**ToolNet API uses a 3-tier pricing strategy:**
...
**Yes, ToolNet API itself is 100% free and open source.**
...
**Yes! This is ToolNet API's core feature.**
...
**ToolNet API tracks quota in real-time for all providers:**
...
## Can I self-host ToolNet API?

**Yes! ToolNet API supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.toolnetapi`)
...
**Yes, ToolNet API prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.toolnetapi` (or custom `DATA_DIR`)
- No data sent to ToolNet API servers
...
**What ToolNet API stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What ToolNet API does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/toolnetapi/blob/main/CHANGELOG.md)
- Backup `~/.toolnetapi` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/toolnetapi/blob/main/CONTRIBUTING.md) for details.
