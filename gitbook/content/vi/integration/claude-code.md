...
Tích hợp ToolNet API với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của ToolNet API.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model ToolNet API:
