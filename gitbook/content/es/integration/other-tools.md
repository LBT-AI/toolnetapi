...
ToolNet API es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

ToolNet API proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a ToolNet API usando estas configuraciones:

**ToolNet API local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de ToolNet API (cc/*, cx/*, glm/*, etc.)
```

**ToolNet API en la nube:**
```
...
**Problema:** No se puede conectar a ToolNet API
```bash
# Verifica si ToolNet API está corriendo
...
**Solución:**
- Verifica que ToolNet API esté corriendo
...
- Verifica la conexión de red a ToolNet API
