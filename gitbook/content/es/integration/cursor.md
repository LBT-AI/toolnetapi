...
Integra ToolNet API con Cursor IDE para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de ToolNet API.

## Requisitos previos

- Cursor IDE instalado
- Cuenta Cursor Pro (requerida para endpoints de API personalizados)
- Endpoint en la nube de ToolNet API configurado
...
3. Ingresa el nombre del modelo desde tu configuración de ToolNet API (ej. `gpt-4`, `claude-opus-4-5`, etc.)
4. Clic en **Add**
...
3. ¡Empieza a usar ToolNet API con Cursor!
...
3. Comienza a chatear con IA a través de ToolNet API
...
3. Ingresa tu prompt
4. Cursor usará ToolNet API para generar código
...
4. Obtén explicaciones potenciadas por IA a través de ToolNet API
...
Si estás ejecutando ToolNet API localmente y quieres usarlo con Cursor:

1. Habilita el endpoint en la nube en la configuración de ToolNet API
2. Configura tu URL del endpoint en la nube en el dashboard de ToolNet API
3. Usa la URL en la nube en la configuración de Cursor
4. Asegúrate de que tu instancia local de ToolNet API sea accesible desde internet

## Mejores prácticas

1. **Usa aliases de modelos**: Crea aliases cortos para modelos usados con frecuencia en ToolNet API
