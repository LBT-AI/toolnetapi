...
```bash
toolnetapi                    # Start with default settings
toolnetapi --port 8080        # Custom port
toolnetapi --no-browser       # Don't open browser
toolnetapi --skip-update      # Skip auto-update check
toolnetapi --help             # Show all options
```
...
- **macOS/Linux**: `~/.toolnetapi/db/data.sqlite`
- **Windows**: `%APPDATA%/toolnetapi/db/data.sqlite`
- **Docker**: `/app/data/db/data.sqlite` (mount `$HOME/.toolnetapi` to persist)
