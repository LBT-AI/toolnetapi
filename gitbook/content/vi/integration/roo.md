...
Tích hợp ToolNet API với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model ToolNet API có sẵn:
...
### Connection Failed
- Xác minh ToolNet API đang chạy: `curl http://localhost:20128/health`
