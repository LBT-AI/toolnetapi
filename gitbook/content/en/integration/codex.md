...
Integrate ToolNet API with OpenAI Codex CLI to route your OpenAI API requests through ToolNet API's intelligent routing system.
...
ToolNet API provides the following Codex models:
...
1. Verify your API key is correct in ToolNet API dashboard
...
1. Verify the model name matches your ToolNet API configuration
2. Check that the OpenAI provider connection is active in ToolNet API dashboard
