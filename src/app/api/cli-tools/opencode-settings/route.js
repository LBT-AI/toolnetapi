...
// POST - Apply ToolNet API as openai-compatible provider (multi-model support)
...
// DELETE - Remove ToolNet API provider or specific models from config
export async function DELETE(request) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: modelToRemove ? `Model "${modelToRemove}" removed` : "ToolNet API settings removed from OpenCode",
    });
  } catch (error) {
