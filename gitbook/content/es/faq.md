...
Preguntas comunes sobre ToolNet API.

---

## ¿Qué es ToolNet API?

**ToolNet API es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**ToolNet API usa una estrategia de precios de 3 niveles:**
...
## ¿ToolNet API es gratis?

**Sí, ToolNet API en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de ToolNet API.**
...
**ToolNet API rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar ToolNet API?

**¡Sí! ToolNet API soporta múltiples opciones de despliegue:**
