...
/**
 * Normalizes an X.509 certificate string into strict standard PEM format.
 * Trims extra headers, footer, whitespace, and rewraps lines at 64 characters.
...
export function createSamlInstance(settings, origin) {
  ...
  return new SAML({
    ...
    issuer: settings?.samlIssuer || "urn:toolnetapi:sp",
    idpCert: cert,
    cert: cert,
