...
export const CLI_TOOLS = {
  ...
  amp: {
    ...
    notes: [
      { type: "info", text: "Use ToolNet API model aliases to keep Amp shorthand mappings stable across provider updates." },
    ...
    guideSteps: [
      ...
      { step: 5, title: "Add Shorthands", desc: "Map Amp shorthand names such as g25p or cs45 to ToolNet API aliases in your local config." },
    ],
    codeBlock: {
      language: "bash",
...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  qwen: {
    ...
    color: "#10B981",
    description: "Alibaba Qwen Code CLI — supports OpenAI, Anthropic & Gemini providers via ToolNet API",
    docsUrl: "https://qwenlm.github.io/qwen-code-docs/en/users/configuration/model-providers/",
    configType: "guide",
    defaultCommand: "qwen",
    notes: [
      { type: "info", text: "Qwen Code supports multiple provider types (openai, anthropic, gemini) via modelProviders in settings.json. ToolNet API works as an OpenAI-compatible endpoint." },
      { type: "info", text: "Any model available in ToolNet API can be used — not just Qwen models. Select from Qwen, Claude, Gemini, GPT, and more." },
      { type: "warning", text: "Config path: Linux/macOS ~/.qwen/settings.json • Windows %USERPROFILE%\\.qwen\\settings.json" },
      { type: "error", text: "Qwen OAuth free tier was discontinued on 2026-04-15. Use ToolNet API with alicode/openrouter/anthropic/gemini providers instead." },
    ],
  ...
  "deepseek-tui": {
    ...
    notes: [
      { type: "info", text: "DeepSeek TUI uses ~/.deepseek/config.toml for configuration. ToolNet API will update the provider to 'openai' mode with your base_url, api_key, and model." },
  ...
  bobide: {
    id: "bobide",
    name: "IBM Bob IDE",
    image: "/providers/bobide.png",
    icon: "smart_toy",
    color: "#0F62FE",
    description: "IBM Bob AI-powered Software Development Lifecycle IDE & CLI",
    configType: "custom",
    docsUrl: "https://ibm.com/bob",
    defaultCommand: "bob",
    modelAliases: [
      "granite-code-3b",
      "granite-code-8b",
    ...
    defaultModels: [
      { id: "granite-code-3b", name: "IBM Granite Code (3B)", desc: "Siêu nhỏ nhẹ, tối ưu cho auto-complete", alias: "granite-3b", defaultValue: "bob/granite-code-3b" },
      { id: "granite-code-8b", name: "IBM Granite Code (8B)", desc: "Cân bằng cho giải thích code", alias: "granite-8b", defaultValue: "bob/granite-code-8b" },
      { id: "granite-code-20b", name: "IBM Granite Code (20B)", desc: "Quét lỗi bảo mật", alias: "granite-20b", defaultValue: "bob/granite-code-20b" },
      { id: "granite-code-34b", name: "IBM Granite Code (34B)", desc: "Viết các cấu trúc hàm ngắn", alias: "granite-34b", defaultValue: "bob/granite-code-34b" },
      { id: "codestral-22b", name: "Mistral Codestral 22B", desc: "Đối tác mã nguồn mở phục vụ tác vụ phổ thông ngoài hệ sinh thái IBM i", alias: "codestral", defaultValue: "bob/codestral-22b" },
      { id: "mistral-7b", name: "Mistral 7B Instruct", desc: "Mã nguồn mở phục vụ tác vụ phổ thông ngoài hệ sinh thái IBM i", alias: "mistral-7b", defaultValue: "bob/mistral-7b" },
      { id: "o3", name: "OpenAI o3", desc: "Mô hình lý luận thế hệ mới nhất của OpenAI", alias: "o3", defaultValue: "bob/o3" },
      { id: "claude-4-opus", name: "Claude 4 Opus", desc: "Mô hình mạnh mẽ nhất của Anthropic", alias: "claude-4-opus", defaultValue: "bob/claude-4-opus" },
      { id: "claude-3-5-sonnet", name: "Claude 3.5 Sonnet", desc: "Tốc độ và độ thông minh cân bằng nhất", alias: "claude-3-5-sonnet", defaultValue: "bob/claude-3-5-sonnet" },
      { id: "gpt-4o", name: "GPT-4o", desc: "Mô hình đa phương thức phản hồi cực nhanh", alias: "gpt-4o", defaultValue: "bob/gpt-4o" },
      { id: "gpt-4o-mini", name: "GPT-4o mini", desc: "Bản rút gọn siêu tốc tiết kiệm token", alias: "gpt-4o-mini", defaultValue: "bob/gpt-4o-mini" },
      { id: "claude-3-5-haiku", name: "Claude 3.5 Haiku", desc: "Gọn nhẹ thế hệ mới tối ưu chi phí", alias: "claude-3-5-haiku", defaultValue: "bob/claude-3-5-haiku" },
      { id: "claude-3-haiku", name: "Claude 3 Haiku", desc: "Phiên bản Haiku đời đầu phản hồi nhanh", alias: "claude-3-haiku", defaultValue: "bob/claude-3-haiku" },
      { id: "gemini-1.5-flash", name: "Gemini 1.5 Flash", desc: "Context Window rộng đọc tệp mã nguồn lớn", alias: "gemini-1.5-flash", defaultValue: "bob/gemini-1.5-flash" },
    ],
    notes: [
      {
        type: "info",
        text: "IBM Bob tích hợp đầy đủ danh sách model Free: IBM Granite Code (3B/8B/20B/34B), Codestral, Mistral 7B, OpenAI o3/GPT-4o/mini, Claude Opus/Sonnet/Haiku và Gemini 1.5 Flash.",
      },
      {
        type: "info",
        text: "ToolNet API tự động cấu hình các model trên vào ~/.bob/settings.json hoặc ~/.bobide/settings.json.",
      },
      {
        type: "warning",
        text: "Config path: Linux/macOS ~/.bob/settings.json (hoặc ~/.bobide/settings.json) • Windows %USERPROFILE%\.bob\settings.json",
      },
    ],
  },
  // HIDDEN: gemini-cli
