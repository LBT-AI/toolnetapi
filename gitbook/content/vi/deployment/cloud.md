...
Triển khai ToolNet API trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.toolnetapi` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/toolnetapi`:
...
# If NOT using reverse proxy, allow ToolNet API ports
