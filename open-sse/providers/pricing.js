...
export const PROVIDER_PRICING = {
  ...
  tokenrouter: {
    ...
    "openai/gpt-5": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5-image": { input: 2.5, output: 10.0, reasoning: 10.0 },
    "openai/gpt-5-image-mini": { input: 2.5, output: 10.0, reasoning: 10.0 },
    "openai/gpt-5-mini": { input: 0.15, output: 0.6, cached: 0.075, reasoning: 0.6 },
    "openai/gpt-5.2": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5.4": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5.4-image-2": { input: 2.5, output: 10.0, reasoning: 10.0 },
    "openai/gpt-5.4-mini": { input: 0.15, output: 0.6, cached: 0.075, reasoning: 0.6 },
    "openai/gpt-5.4-nano": { input: 0.15, output: 0.6, cached: 0.075, reasoning: 0.6 },
    "openai/gpt-5.4-pro": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5.5": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5.5-pro": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5.6-luna": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5.6-sol": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-5.6-terra": { input: 2.5, output: 10.0, cached: 1.25, reasoning: 10.0 },
    "openai/gpt-audio": { input: 2.5, output: 10.0, reasoning: 10.0 },
    "openai/gpt-audio-mini": { input: 2.5, output: 10.0, reasoning: 10.0 },
    "openai/gpt-oss-120b": { input: 0.1, output: 0.2, cached: 0.05, reasoning: 0.2 },
    "qwen/qwen3-coder-next": { input: 0.4, output: 1.2, cached: 0.04, reasoning: 1.2 },
    "qwen/qwen3.5-122b-a10b": { input: 0.4, output: 1.2, cached: 0.04, reasoning: 1.2 },
    "qwen/qwen3.5-35b-a3b": { input: 0.2, output: 0.6, cached: 0.02, reasoning: 0.6 },
    "qwen/qwen3.5-397b-a17b": { input: 1.5, output: 4.5, cached: 0.15, reasoning: 4.5 },
    "qwen/qwen3.5-9b": { input: 0.1, output: 0.3, cached: 0.01, reasoning: 0.3 },
    "qwen/qwen3.5-flash": { input: 0.15, output: 0.6, cached: 0.015, reasoning: 0.6 },
    "qwen/qwen3.5-plus-02-15": { input: 0.8, output: 2.4, cached: 0.08, reasoning: 2.4 },
    "qwen/qwen3.6-plus": { input: 0.8, output: 2.4, cached: 0.08, reasoning: 2.4 },
    "qwen/qwen3.7-max": { input: 1.5, output: 6.0, cached: 0.15, reasoning: 6.0 },
    "qwen/qwen3.7-plus": { input: 0.8, output: 2.4, cached: 0.08, reasoning: 2.4 },
    "qwen/qwen3.8-max": { input: 1.5, output: 6.0, cached: 0.15, reasoning: 6.0 },
    "qwen3.5-omni-plus": { input: 0.1, output: 0.3, cached: 0.01, reasoning: 0.3 },
    "qwen3.6-flash": { input: 0.15, output: 0.6, cached: 0.015, reasoning: 0.6 },
    "sakana/fugu-ultra": { input: 2.5, output: 10.0, cached: 0.25, reasoning: 10.0 },
    "seed-2-0-code-preview-260328": { input: 0.25, output: 0.5, cached: 0.125, reasoning: 0.5 },
    "seed-2-0-lite-260428": { input: 0.15, output: 0.3, cached: 0.075, reasoning: 0.3 },
    "seed-2-0-mini-260428": { input: 0.05, output: 0.1, cached: 0.025, reasoning: 0.1 },
    "seed-2-0-pro-260328": { input: 0.5, output: 1.0, cached: 0.25, reasoning: 1.0 },
    "stepfun/step-3.5-flash": { input: 0.1, output: 0.4, cached: 0.01, reasoning: 0.4 },
    "stepfun/step-3.7-flash": { input: 0.1, output: 0.4, cached: 0.01, reasoning: 0.4 },
    "tencent/hy3-preview": { input: 0.2, output: 0.8, cached: 0.02, reasoning: 0.8 },
    "x-ai/grok-4.1-fast": { input: 2.0, output: 10.0, cached: 0.2, reasoning: 10.0 },
    "x-ai/grok-4.20-beta": { input: 2.0, output: 10.0, cached: 0.2, reasoning: 10.0 },
    "x-ai/grok-4.3": { input: 2.0, output: 10.0, cached: 0.2, reasoning: 10.0 },
    "x-ai/grok-4.5": { input: 2.0, output: 10.0, cached: 0.2, reasoning: 10.0 },
    "x-ai/grok-build-0.1": { input: 2.0, output: 10.0, cached: 0.2, reasoning: 10.0 },
    "xiaomi/mimo-v2-flash": { input: 0.3, output: 0.8, cached: 0.03, reasoning: 0.8 },
    "xiaomi/mimo-v2-omni": { input: 1.2, output: 3.5, cached: 0.12, reasoning: 3.5 },
    "xiaomi/mimo-v2-pro": { input: 1.2, output: 3.5, cached: 0.12, reasoning: 3.5 },
    "xiaomi/mimo-v2.5": { input: 0.3, output: 0.8, cached: 0.03, reasoning: 0.8 },
    "xiaomi/mimo-v2.5-pro": { input: 1.2, output: 3.5, cached: 0.12, reasoning: 3.5 },
    "z-ai/glm-4.5-air": { input: 0.1, output: 0.1, cached: 0.1, reasoning: 0.1 },
    "z-ai/glm-4.6": { input: 10, output: 10, cached: 10, reasoning: 10 },
    "z-ai/glm-4.6v": { input: 5, output: 5, cached: 5, reasoning: 5 },
    "z-ai/glm-4.7": { input: 100, output: 100, cached: 100, reasoning: 100 },
    "z-ai/glm-5": { input: 100, output: 100, cached: 100, reasoning: 100 },
    "z-ai/glm-5-turbo": { input: 0.1, output: 0.1, cached: 0.1, reasoning: 0.1 },
    "z-ai/glm-5.1": { input: 100, output: 100, cached: 100, reasoning: 100 },
    "z-ai/glm-5.2": { input: 100, output: 100, cached: 100, reasoning: 100 },
  }
};
