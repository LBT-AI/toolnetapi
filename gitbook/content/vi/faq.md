...
Những câu hỏi phổ biến về ToolNet API.

---

## ToolNet API là gì?

**ToolNet API là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**ToolNet API dùng chiến lược pricing 3 tầng:**
...
## ToolNet API có miễn phí không?

**Có, ToolNet API hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của ToolNet API.**
...
**ToolNet API theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host ToolNet API không?

**Có! ToolNet API hỗ trợ nhiều tùy chọn deployment:**
...
## Làm thế nào để cập nhật ToolNet API?
