...
Integra ToolNet API con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de ToolNet API.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- ToolNet API ejecutándose localmente o endpoint en la nube configurado
- API key del dashboard de ToolNet API
...
Establece la URL base a tu endpoint de ToolNet API:

**Para ToolNet API local:**
```
...
**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de ToolNet API
...
1. En el dropdown **Model**, puedes:
   ...
   - Ingresar manualmente el nombre del modelo desde tu configuración de ToolNet API
...
Puedes usar cualquier modelo configurado en tu dashboard de ToolNet API. Ejemplos comunes:
...
4. Cline usará ToolNet API para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando ToolNet API
...
3. Obtén explicaciones potenciadas por IA a través de ToolNet API

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará ToolNet API para entender el contexto y hacer cambios
...
1. Verifica que ToolNet API esté corriendo: `curl http://localhost:20128/health`
...
1. Verifica que el nombre del modelo coincida exactamente con tu configuración de ToolNet API
2. Verifica que la conexión del proveedor esté activa en el dashboard de ToolNet API
...
2. Verifica que tu instancia de ToolNet API esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de ToolNet API para cualquier error
...
2. **Monitorea el uso**: Revisa el dashboard de ToolNet API para estadísticas de uso y costos
...
## Integración con características de ToolNet API

### Enrutamiento de modelos

ToolNet API enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, ToolNet API automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de ToolNet API:
