...
Problemas comunes y soluciones al usar ToolNet API.
...
1. **Refresh automático (por defecto):**
   ToolNet API refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Causas:**
- ToolNet API no está ejecutándose
- Puerto 20128 bloqueado
- Firewall bloqueando la conexión

**Soluciones:**

1. **Inicia ToolNet API:**
   ```bash
   toolnetapi
   ```
...
1. **Verifica si ToolNet API está ejecutándose:**
   ```bash
   # Verifica el proceso
