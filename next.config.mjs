...
const tracingRoot = process.env.NEXT_TRACING_ROOT_MODE === "workspace"
  ? join(projectRoot, "..")
  : projectRoot;
const proxyClientMaxBodySize = process.env.TOOLNET_PROXY_CLIENT_MAX_BODY_SIZE || process.env.NINEROUTER_PROXY_CLIENT_MAX_BODY_SIZE || "128mb";
...
const nextConfig = {
  ...
  // A release built on one OS then ships `file:///Users/.../open/index.js`, which
  ...
  // import — including xAI/Grok/Codex/Gemini OAuth flows, which load the service that
  // imports it. Keeping it external preserves the real `import.meta.url` at runtime.
