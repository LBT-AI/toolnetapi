---
name: toolnetapi-embeddings
description: Generate vector embeddings via ToolNet API /v1/embeddings using OpenAI / Gemini / Mistral / Voyage / Nvidia / GitHub embedding models for RAG, semantic search, similarity. Use when the user wants embeddings, vectors, RAG, semantic search, or to embed text.
---

# ToolNet API — Embeddings
