...
Integrate ToolNet API with Cursor IDE to route your AI requests through ToolNet API's intelligent routing system.

## Prerequisites

- Cursor IDE installed
- Cursor Pro account (required for custom API endpoints)
- ToolNet API cloud endpoint configured
...
3. Enter the model name from your ToolNet API configuration (e.g., `gpt-4`, `claude-opus-4-5`, etc.)
4. Click **Add**
...
3. Start using ToolNet API with Cursor!
...
3. Start chatting with AI through ToolNet API
...
2. Press Cmd/Ctrl + K
3. Enter your prompt
4. Cursor will use ToolNet API to generate code
...
4. Get AI-powered explanations through ToolNet API
...
If you're running ToolNet API locally and want to use it with Cursor:

1. Enable cloud endpoint in ToolNet API settings
2. Configure your cloud endpoint URL in ToolNet API dashboard
3. Use the cloud URL in Cursor settings
4. Ensure your local ToolNet API instance is accessible from the internet

## Best Practices

1. **Use Model Aliases**: Create short aliases for frequently used models in ToolNet API
