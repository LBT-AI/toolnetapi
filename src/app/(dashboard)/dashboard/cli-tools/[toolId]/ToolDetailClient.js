...
import {
  ...
  JcodeToolCard, GrokBuildToolCard, BobideToolCard,
} from "../components";
...
export default function ToolDetailClient({ toolId, machineId }) {
  ...
  const renderToolCard = () => {
    ...
    switch (toolId) {
      ...
      case "bobide":
      case "bob":
        return <BobideToolCard {...commonProps} activeProviders={getActiveProviders()} hasActiveProviders={hasActiveProviders} cloudEnabled={cloudEnabled} />;
      default:
