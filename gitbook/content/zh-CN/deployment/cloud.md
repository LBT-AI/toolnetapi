...
将 ToolNet API 部署到 VPS 或 Docker,实现远程访问和生产使用。
...
| `DATA_DIR` | `~/.toolnetapi` | 数据库与数据存储路径 |
...
创建 `/etc/nginx/sites-available/toolnetapi`:
