...
ToolNet API tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

ToolNet API cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến ToolNet API bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến ToolNet API
```bash
...
**Giải pháp:**
- Xác minh ToolNet API đang chạy
...
- Kiểm tra kết nối network đến ToolNet API
