...
const ROOT_CA_CN = "ToolNet API MITM Root CA";
...
async function installCertMac(sudoPassword, certPath) {
  ...
  const deleteOld = `security delete-certificate -c "ToolNet API MITM Root CA" /Library/Keychains/System.keychain 2>/dev/null || true`;
