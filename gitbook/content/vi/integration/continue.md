...
Tích hợp ToolNet API với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.
...
### 2. Thêm Cấu hình Model ToolNet API
...
3. Chọn model ToolNet API ưa thích
...
- Kiểm tra ToolNet API đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến ToolNet API
