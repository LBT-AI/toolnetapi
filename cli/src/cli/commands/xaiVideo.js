/**
 * `toolnetapi xai video` — generate a Grok Imagine video through the local
 * toolnetapi gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: toolnetapi xai video --prompt "..." [options]

Generate a Grok Imagine video via your local toolnetapi gateway
...
Options:
  ...
  --api-key <key>         toolnetapi API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-toolnetapi-connection-id"] || null;
