...
ToolNet APIをOpenAI Codex CLIと統合し、OpenAI APIリクエストをToolNet APIのインテリジェントルーティングシステム経由でルーティングします。
...
1. ToolNet APIダッシュボードでAPIキーが正しいか確認
...
1. モデル名がToolNet API設定と一致するか確認
2. ToolNet APIダッシュボードでOpenAIプロバイダー接続がアクティブか確認
