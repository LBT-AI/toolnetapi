...
Integra ToolNet API con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.
...
### 2. Agregar configuración de modelo de ToolNet API
...
```json
{
  "models": [
    {
      "title": "ToolNet API - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "ToolNet API - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "ToolNet API - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "ToolNet API - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de ToolNet API
...
```json
{
  "models": [
    {
      "title": "ToolNet API - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que ToolNet API esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de ToolNet API
...
- Verifica la latencia de red hacia ToolNet API
