...
const PROVIDER_NAME = "toolnetapi";
...
// Detect toolnetapi by base_url containing localhost/127.0.0.1 or matching tunnel URL
const hasToolNetAPIConfig = (modelCfg) => {
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      installed: true,
      settings: { model },
      hasToolNetAPI: hasToolNetAPIConfig(model),
