...
Integrate ToolNet API with Claude Code CLI to route your Anthropic API requests through ToolNet API's intelligent routing system.
...
Claude Code supports the following model aliases that map to ToolNet API models:
