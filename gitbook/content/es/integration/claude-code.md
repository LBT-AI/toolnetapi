...
Integra ToolNet API con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de ToolNet API.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de ToolNet API:
